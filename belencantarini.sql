...
INSERT INTO `tratamientos` VALUES (9,'Hilos tensores',15000,'https://http2.mlstatic.com/D_NQ_NP_777336-MLA52754808975_122022-O.webp','Resistente al agua, con fuerte elasticidad, tu cara no estará apretada. Levanta y reafirma inmediatamente la piel para crear una cara en forma de V.\r\nLevantamiento: el sistema de elevación de cara y cuello mejora la piel suelta y elimina las arrugas en la cara, la barbilla del cuello y el área de los ojos.\r\nDebe encoger los músculos faciales flacidos y dar forma a su cara. Ayuda a dar forma a una cara delgada y firme y a crear una cara hermosa.\r\nEs ideal para ocasiones especiales, bodas, reuniones, modelado, fotografía, viajes, etc.','finalizado'),(81,'Botox',15500,'./imagenes/replication (3)0.png','Atenua o elimina arrugas de expresion','finalizado'),(84,'Botox',12000,'./imagenes/replication (2)0.png','Empeza hoy ese tratamiento que siempre quisiste!!!','finalizado');
...
-- Dump completed on 2023-03-10  8:11:52
