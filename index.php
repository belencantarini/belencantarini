    ...
    <main class="flex-grow-1">
        <section>
            <div class="banner">
                ...
                <button type="button" class="btn btn-outline-dark"><a href="tienda.php" class="text-decoration-none text-white">Quiero saber más!</a></button>
                <button type="button" class="btn-purple btn "><a href="contacto.php" class="text-white text-decoration-none">Contacto</a></button>
            </div>
        </section>
